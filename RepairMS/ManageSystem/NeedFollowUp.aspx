    ...
    <form id="form1" runat="server">
        ...
        <div style="width: 1200px; margin: auto;">
            ...
            <div id="div_gridDetail">
                <telerik:RadGrid ID="GridDetail" runat="server" Height="500px" AllowAutomaticInserts="True" OnNeedDataSource="GridDetail_NeedDataSource" AutoGenerateColumns="False" AutoGenerateDeleteColumn="True" OnDeleteCommand="GridDetail_DeleteCommand" OnItemCommand="GridDetail_ItemCommand" OnItemDataBound="GridDetail_ItemDataBound">
                    <ClientSettings EnablePostBackOnRowClick="False" EnableRowHoverStyle="True">
                        <Selecting AllowRowSelect="True" />
                        <Scrolling AllowScroll="True" UseStaticHeaders="True"></Scrolling>
                    </ClientSettings>
                    <MasterTableView DataKeyNames="detailID" CommandItemDisplay="Top" EditMode="EditForms" AllowAutomaticInserts="False">
